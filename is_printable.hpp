#ifndef IS_PRINTABLE_HPP_INCLUDE_GUARD
#define IS_PRINTABLE_HPP_INCLUDE_GUARD
...
template<typename T>
struct printer // class template to support partial specialization
{
  // Print the specified 'obj' to 'stdout'.
  // Unless specialized, call 'fmt::print({}, obj)'.
  void operator () (T const& obj) {
    fmt::print("{}", obj);
  }
};

// Print the specified 'obj' to 'stdout', as if by calling 'lib::printer<T>{}(obj)'.
template<typename T>
...
#endif // IS_PRINTABLE_HPP_INCLUDE_GUARD
